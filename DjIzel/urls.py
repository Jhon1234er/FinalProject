...
urlpatterns = [
    ...
    # ** URLs para IT **
    path('it/registrar/', crear_it, name='registrar_it'),
    path('it/listar/', lista_it, name='listar_it'),
    path('it/actualizar/<int:id>/', actualizar_it, name='actualizar_it'),
    path('it/eliminar/<int:id>/', eliminar_it, name='eliminar_it'),
    ...
    # ** URLs para Usuario (Usuario Base) **
    ...
    # ** URLs para CertificadoIncapacidad **
