"""
Django settings for DjIzel project.
...
SECRET_KEY = 'django-insecure-ru)lml0^*0n&js6&26nug*cw)7i!shzs@rnl4uj0w91etcr9w_'
...
MIDDLEWARE = [
    ...
    'Izelapp.views.SessionExpiredMiddleware',

]

ROOT_URLCONF = 'DjIzel.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'Izelapp.context_processors.tipo_usuario_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'DjIzel.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Asegúrate que esta línea esté si usas una carpeta 'static' para desarrollo
]
STATIC_ROOT = BASE_DIR / "staticfiles"  # Esta línea es la clave para producción y collectstatic
