# Generated by Django 5.1.6 on 2025-04-22 22:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('VIG', 'Vigente'), ('VEN', 'Vencida'), ('AG', 'Agendada'), ('PA', 'Por autorizar'), ('AUT', 'Por autorizar')], max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medico', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='medico_datos_quirurjicos', to='Izelapp.medico')),
