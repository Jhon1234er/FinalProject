    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_doc', models.CharField(choices=[('C.C', 'c.c'), ('T.I', 't.i'), ('C.E', 'c.e')], max_length=20)),
        ...
        migrations.CreateModel(
            name='Empleado',
            fields=[
                ('usuario_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='Izelapp.usuario')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ultima_atencion', models.DateField(auto_now_add=True)),
                ('tratamiento', models.TextField(max_length=200)),
                ('notas', models.TextField(max_length=200)),
                ('paciente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='historias_clinicas', to='Izelapp.paciente')),
            ],
        ),
        migrations.CreateModel(
            name='DatoQuirurgico',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medico', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='medico_horario', to='Izelapp.medicos')),
            ],
        ),
        migrations.AddField(
            model_name='cita',
            name='medico',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='medico_citas', to='Izelapp.medicos'),
        ),
    ]
